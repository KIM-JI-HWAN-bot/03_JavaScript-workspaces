 ...
 */
(function () {
  console.log("익명함수 즉시실행! 함수 정의와 동시 호출");
})();
...
console.log(apply(5, increase)); // 즉정 값을 1증가 시키고 싶음
console.log(apply(5, decrease)); // 즉정 값을 1감소 시키고 싶음

console.log(apply(5, (a) => a * 2)); // 즉정 값을 2배 증가 시키고 싶음
console.log(apply(5, (a) => a * 3)); // 즉정 값을 3배 증가 시키고 싶음
