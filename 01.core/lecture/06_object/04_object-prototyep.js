...
// EV 생성자 함수로 생성되는 객체 마다 공통적으로 car 객체의 프로퍼티 가지게끔
EV.prototype = car;
...
// 생성자 함수의 prototype 활용하여 메소드 정의 하는 방법
...
/*
 1. 메모리 효율성
  - 생성자 함수 내에 정의 : 인스턴스 마다 독립적인 메소드 복사본이 생성됨
  - 인스턴스가 많아질수록 메모리 사용량이 증가됨
  - prototype에 정의 : 모든 인스턴스가 동일한 메소드 공유함 (싱글톤)

 2. 동적 업데이트 가능성
  - 생성자 함수 내의 정의 : 각 인스턴스 마다 메소드 일일히 수정해야됨
