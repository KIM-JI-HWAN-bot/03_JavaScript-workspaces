...
console.log("제 이른은 " + lastName + fistsName + "입니다,");

// 해결.템플릿 리터럴 + 표현식삽입구문(${})
console.log(`제 이름은 ${lastName}${fistsName}입니다.`);
...
var bigInt = 123456789123456789123456789000n;
